      ...
      <Layout>
        <div className="flex flex-col px-4 md:px-6 my-4 md:my-6 space-y-4 md:space-y-6">
          <div className='flex flex-col'>
            <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-teal-800 dark:text-teal-300 font-bold">Badge</p>
            <p className='text-sm md:text-base text-sky-800 dark:text-sky-300'>Examples for badges, our small count and labeling component.</p>
          </div>
          <div className='flex flex-col md:flex-row space-x-0 md:space-x-6 space-y-6 md:space-y-0'>
            <div className='flex flex-col space-y-6 lg:space-y-8 basis-1/2'>
              ...
              <div className='flex flex-col bg-white dark:bg-slate-900 p-4 rounded-lg space-y-4 drop-shadow-sm h-fit'>
                <p className='text-teal-800 dark:text-teal-300 font-bold text-base md:text-lg'>Variation</p>
              ...
              {/* Badge light */}
              <div className='flex flex-col bg-white dark:bg-slate-900 p-4 rounded-lg space-y-4 drop-shadow-sm h-fit'>
                <p className='text-teal-800 dark:text-teal-300 font-bold text-base md:text-lg'>Light</p>
                <div className='flex flex-wrap justify-between'>
              ...
              <div className='flex flex-col bg-white dark:bg-slate-900 p-4 rounded-lg space-y-4 drop-shadow-sm h-fit'>
                ...
                <div className='flex flex-col space-y-4'>
                  <div className='flex space-x-2 items-center'>
                    <p className='text-[36px] lg:text-[40px] font-bold text-sky-800 dark:text-sky-400'>Heading 1</p>
                    <div className='text-white bg-gray-700 p-1 text-[32px] lg:text-[36px] rounded-lg'>
                      New
                    </div>
                  </div>
                  <div className='flex space-x-2 items-center'>
                    <p className='text-[28px] lg:text-[32px] font-bold text-sky-800 dark:text-sky-400'>Heading 2</p>
                    <div className='text-white bg-gray-700 p-1 rounded-lg text-[24px] lg:text-[28px]'>
                      New
                    </div>
                  </div>
                  <div className='flex space-x-2 items-center'>
                    <p className='text-[24px] lg:text-[28px] font-bold text-sky-800 dark:text-sky-400'>Heading 3</p>
                    <div className='text-white bg-gray-700 p-1 rounded-lg text-[20px] lg:text-[24px]'>
                      New
                    </div>
                  </div>
                  <div className='flex space-x-2 items-center'>
                    <p className='text-[20px] lg:text-[24px] font-bold text-sky-800 dark:text-sky-400'>Heading 4</p>
                    <div className='text-white bg-gray-700 p-1 rounded-lg text-[16px] lg:text-[20px]'>
                      New
                    </div>
                  </div>
                  <div className='flex space-x-2 items-center'>
                    <p className='text-[20px] font-bold text-sky-800 dark:text-sky-400'>Heading 5</p>
                    <div className='text-white bg-gray-700 p-1 rounded-lg text-[16px]'>
                      New
                    </div>
                  </div>
                  <div className='flex space-x-2 items-center'>
                    <p className='text-[16px] font-bold text-sky-800 dark:text-sky-400'>Heading 6</p>
            ...
            <div className='flex flex-col basis-1/2'>
              ...
              <div className='flex flex-col bg-white dark:bg-slate-900 basis-1/2 p-4 rounded-lg drop-shadow-sm space-y-4'>
                <p className='text-teal-800 dark:text-teal-300 font-bold text-base md:text-lg'>Button</p>
                <div className='flex flex-col space-y-4'>
                  <p className='text-sky-800 font-semibold dark:text-sky-300'>Simple</p>
