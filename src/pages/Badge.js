          ...
          <div className='flex space-x-6'>
            <div className='flex flex-col space-y-6 lg:space-y-8 basis-1/2'>
              ...
              <div className='flex flex-col bg-white p-4 rounded-lg space-y-4 drop-shadow-sm h-fit'>
                <p className='text-teal-800 font-bold text-lg'>Variation</p>
                <div className='flex space-x-2'>
                  <div className='text-white bg-blue-600 rounded-2xl text-sm py-1 px-2'>
                    Primary
                  </div>
                  <div className='text-white bg-green-600 rounded-2xl text-sm py-1 px-2'>
                    Success
                  </div>
                  <div className='text-white bg-yellow-600 rounded-2xl text-sm py-1 px-2'>
                    Warning
                  </div>
                  <div className='text-white bg-red-600 rounded-2xl text-sm py-1 px-2'>
                    Danger
                  </div>
                  <div className='text-white bg-sky-400 rounded-2xl text-sm py-1 px-2'>
                    Info
                  </div>
                  <div className='text-white bg-gray-800 rounded-2xl text-sm py-1 px-2'>
                    Dark
                  </div>
                  <div className='text-white bg-gray-400 rounded-2xl text-sm py-1 px-2'>
                    Secondary
                  </div>
                </div>
              </div>
              {/* Badge light */}
              <div className='flex flex-col bg-white p-4 rounded-lg space-y-4 drop-shadow-sm h-fit'>
                <p className='text-teal-800 font-bold text-lg'>Light</p>
                <div className='flex space-x-2'>
              ...
              <div className='flex flex-col bg-white p-4 rounded-lg space-y-4 drop-shadow-sm h-fit'>
                ...
                <div className='flex flex-col space-y-4'>
                  <div className='text-blue-800 flex space-x-2 items-center'>
                    <p className='text-[40px] font-bold text-sky-800'>Heading 1</p>
                    <div className='text-white bg-gray-700 p-1 text-[36px] rounded-lg'>
                      New
                    </div>
                  </div>
                  <div className='text-blue-800 flex space-x-2 items-center'>
                    <p className='text-[32px] font-bold text-sky-800'>Heading 2</p>
                    <div className='text-white bg-gray-700 p-1 rounded-lg text-[28px]'>
                      New
                    </div>
                  </div>
                  <div className='text-blue-800 flex space-x-2 items-center'>
                    <p className='text-[28px] font-bold text-sky-800'>Heading 3</p>
                    <div className='text-white bg-gray-700 p-1 rounded-lg text-[24px]'>
                      New
                    </div>
                  </div>
                  <div className='text-blue-800 flex space-x-2 items-center'>
                    <p className='text-[24px] font-bold text-sky-800'>Heading 4</p>
                    <div className='text-white bg-gray-700 p-1 rounded-lg text-[20px]'>
                      New
                    </div>
                  </div>
                  <div className='text-blue-800 flex space-x-2 items-center'>
            ...
            <div className='flex flex-col basis-1/2'>
              ...
              <div className='flex flex-col bg-white basis-1/2 p-4 rounded-lg drop-shadow-sm space-y-4'>
                <p className='text-teal-800 font-bold text-lg'>Button</p>
                <div className='flex flex-col space-y-4'>
